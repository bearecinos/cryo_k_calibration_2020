...
mask_file = os.path.join(MAIN_PATH,
            'input_data/RACMO/Icemask_Topo_Iceclasses_lon_lat_average_1km.nc')
...
smb_path = os.path.join(MAIN_PATH,
        'input_data/RACMO/smb_rec.1958-2018.BN_RACMO2.3p2_FGRN055_GrIS.MM.nc')
...
graphics.plot_centerlines(gdirs[0], ax=ax2, title='', add_colorbar=False,
...
sm.set_vmin(-200)
sm.set_vmax(200)
sm.visualize(ax=ax1, addcbar=False) #,  cbar_title='SMB mean 61-90 \n (mm. w.e)')
